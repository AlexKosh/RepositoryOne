(function () {
    ...
    function ProductionController($scope, $modal, prodDataService) {
        ...
        (function () {
            ...
            //$scope.resultItem = $scope.resultItemNext = {
            //    Id: 0,
            //    Name: '',
            //    Quantity: 0,
            //    UnitOfMeasurement: '',
            ...
            //            if (index == 0) {
            //                $scope.resultItem = rI;
            //                $scope.resultSumCurrent = countTheSum();
            //            } else {
            //                $scope.resultItemNext = rI;
            //                $scope.resultSumNext = countTheSum();
            //            }
            //        }
            //    });
            //}

            //$scope.showNextTaskSum = function () {
            //    if ($scope.isGotData.qTasks == true) {
            //        var item = getItemByID($scope.resultItemNext.Id);
            ...
            //    }
            //}
            //$scope.showCurrTaskSum = function () {
            //    if ($scope.isGotData.qTasks == true) {

            //        item = getItemByID($scope.resultItem.Id);
            //        if (item.CategoryId == 10) {
            //            return true;
            //        } else {
            //            return false;
            ...
            //    if ($scope.isGotData.qTasks == true) {
            //        if ($scope.quiltingTasks[0].isCompleted == 0) {
            //            return '-- ожидает';
            //        }
            //        return '-- выполняется';
            //    }
            ...
            //            return '---';
            //        } else {
            //            var time = $scope.quiltingTasks[0].StartTime;
            ...
            //    }
            //}
            //$scope.getFinishTime = function () {
            //    if ($scope.isGotData.qTasks == true) {
            //        if ($scope.quiltingTasks[0].isCompleted == 0) {
            //            return '---';
            //        } else {
            //            var time = $scope.quiltingTasks[0].FinishTime;
            ...
            //    $scope.quiltingTasks[0].StartTime = getFormattedDate(new Date());
            //    $scope.quiltingTasks[0].FinishTime = 'вычисляется';

            //    $scope.quiltingTasks[0].isCompleted = 1;
            //}
        })();
